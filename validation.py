...
validation_data = pd.read_csv("H:/CERTH_ImageBlurDataset/Image-Blur-Detection-master/validation.csv")

voting_model = pickle.load(open("H:/CERTH_ImageBlurDataset/Image-Blur-Detection-master/voting_model.pkl", "rb"))
model = pickle.load(open("H:/CERTH_ImageBlurDataset/Image-Blur-Detection-master/XGBoost.pkl","rb"))
